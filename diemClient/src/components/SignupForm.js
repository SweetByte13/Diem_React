                            ...
                            <div className="flex -mx-3">
                                <div className="ml-56 w-1/2  px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="JohnSmith123" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
