...
function Header() {
    return (
        <div className="relative isolate items-center gap-x-6 overflow-hidden bg-gray-50 px-8 py-12 sm:px-3.5 sm:before:flex-1">
            ...
            <div className="pl-44 flex flex-col items-start text-left">
